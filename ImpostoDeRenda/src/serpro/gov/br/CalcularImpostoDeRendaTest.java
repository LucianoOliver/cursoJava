...
public class CalcularImpostoDeRendaTest {
	...
	public void calculosImpostoDevemSerCorretos(){
		CalculaValor  calcula= new DescontoDeTrintaPorCento();
		Contribuinte contribuinte = new PessoaFisica("Joao Santos",3000.00,"11111");
		Double calcular = calcula.calcular(contribuinte);
	
		
		assertEquals(3000.00 * 1.30, calcular,0000.1);
