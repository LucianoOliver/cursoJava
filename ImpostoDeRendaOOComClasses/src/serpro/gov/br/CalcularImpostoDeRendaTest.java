...
public class CalcularImpostoDeRendaTest {
	...
	public void calculosImpostoDevemSerCorretos(){
		...
		assertEquals(3000.00 * 0.10, resultados.get(0) ,0000.1);
		assertEquals(150000.00 * 0.10, resultados.get(1) ,0000.1);
		assertEquals(5000.00 * 0.15, resultados.get(2) ,0000.1);
		assertEquals(2000000.00 * 0.10, resultados.get(3) ,0000.1);
		assertEquals(1500.00 * 0, resultados.get(4) ,0000.1);
		assertEquals(500000.00 * 0.10, resultados.get(5) ,0000.1);
		assertEquals(95000.00 * 0.30, resultados.get(6) ,0000.1);
